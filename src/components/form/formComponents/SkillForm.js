            ...
            <div className="form-div">
                ...
                {this.props.skillArray.map((skillObj) => {
                        if (this.props.skillArray.length === 1) {
                            return <SkillSnippet key={skillObj.id} id={skillObj.id} deleteOn={false} skillChange={this.props.skillChange}/>
                        } 

                        if (this.props.skillArray.length > 1) {
                            return <SkillSnippet key={skillObj.id} id={skillObj.id} deleteOn={true} deleteSkill={this.props.deleteSkill} skillChange={this.props.skillChange}/>
                        }
                        return null;
                    })}
